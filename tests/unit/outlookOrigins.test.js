...
describe("Outlook origin policy integration", () => {
  ...
  it("requires an exact approved renderer source after MCAS normalization", () => {
    for (const source of [
      ...
      "",
      "not a URL",
      "http://outlook.office.com/error.js",
      "https://outlook.office.com:444/error.js",
      "https://user:password@outlook.office.com/error.js",
      "javascript://outlook.office.com/error.js",
      "data://outlook.office.com/error.js",
